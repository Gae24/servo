                    ...
                    for content in contents {
                        match content {
                            ClipboardItem::Text(data) => {
                                drag_data_store.add(Kind::Text(PlainString::new(
                            ...
                            ClipboardItem::Png(data) => {
                                ...
                                drag_data_store.add(Kind::File(binary));
                            },
                        }
                    }
                    // Step 7.1.3 Update clipboard-event-data’s files property to match entries in clipboard-event-data’s items.
